...
export class ViewSwitcherHits extends SearchkitComponent {
    ...
    render() {
        ...
        const props = Object.assign({}, this.props, { itemComponent: selectedOption.itemComponent, listComponent: selectedOption.listComponent, mod: 'sk-hits-' + selectedOption.key });
