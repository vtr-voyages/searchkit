...
describe("InputFilter tests", () => {
    beforeEach(() => {
        ...
        this.createWrapper = (searchOnChange = false, queryFields = null, prefixQueryFields = null, otherProps = {}) => {
            this.wrapper = mount(React.createElement(InputFilter, Object.assign({ searchkit: this.searchkit, id: "test_id", title: "Test title", searchOnChange: searchOnChange, queryFields: queryFields, prefixQueryFields: prefixQueryFields }, otherProps)));
    ...
    it("should accept Panel elements as containerComponent", () => {
        this.createWrapper(true, ["title"], ["prefix"], {
            containerComponent: React.createElement(Panel, { collapsable: true })
        });
