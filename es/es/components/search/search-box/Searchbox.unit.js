...
describe("Searchbox tests", () => {
    beforeEach(() => {
        ...
        this.createWrapper = (searchOnChange = false, queryFields = null, prefixQueryFields = null, options = {}) => {
            this.wrapper = mount(React.createElement(SearchBox, Object.assign({ searchkit: this.searchkit, searchOnChange: searchOnChange, queryFields: queryFields, prefixQueryFields: prefixQueryFields, queryOptions: { minimum_should_match: "60%" }, prefixQueryOptions: { minimum_should_match: "70%" } }, options)));
    ...
    it("should handle focus", () => {
        ...
        expect(this.wrapper.find(".sk-search-box")
